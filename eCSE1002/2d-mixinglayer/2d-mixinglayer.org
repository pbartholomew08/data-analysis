...
#+BEGIN_SRC python :results file :noweb no-export :tangle contour.py
  import numpy as np
  import matplotlib.pyplot as plt
...
Properties: $\Delta{}t=10^{-2}$, skew-symm, ~fpi2=48/7/\pi^2~
...
Properties: $\Delta{}t=10^{-3}$, skew-symm, ~fpi2=48/7/\pi^2~
...
Properties: $\Delta{}t=10^{-2}$, skew-symm, ~fpi2=4~
...
Properties: $\Delta{}t=10^{-3}$, skew-symm, ~fpi2=4~
...
Properties: $\Delta{}t=10^{-2}$, skew-symm, ~fpi2=1~
...
Properties: $\Delta{}t=10^{-3}$, skew-symm, ~fpi2=1~
