...
PROGRAM incompact3d
  ...
  rhomean=0._mytype
  ufmean=0._mytype;vfmean=0._mytype;wfmean=0._mytype ! Favre averages
...
!!$      endif
    ...
    call STATISTIC(rho1, ux1, uy1, uz1, phi1, ta1, rhomean, umean, vmean, wmean, ufmean, vwmean, &
         wfmean, phimean, uumean, vvmean, wwmean, uvmean, uwmean, vwmean, phiphimean, tmean)

#include "postproc-call.inc"
